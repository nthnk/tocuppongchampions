...
export async function POST(request: NextRequest) {
  try {
    ...
    const { teamName, player1FirstName, player1LastName, player2FirstName, player2LastName, email, division, referralCode, referredBy, spectators } = body;

    // Validate required fields
    if (!teamName || !player1FirstName || !player1LastName || !player2FirstName || !player2LastName || !email || !division) {
    ...
    const otpToken = createOTPToken(email, otpCode, { teamName, player1FirstName, player1LastName, player2FirstName, player2LastName, email, division, referralCode: referralCode || '', referredBy: referredBy || '', spectators: Number(spectators) || 0 });
