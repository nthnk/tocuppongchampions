...
const faqs = [
  ...
  },
  {
    ...
    answer: "Yeah, we just want to play cup pong and not have to deal with the liquor licensing laws."
  },
  {
    question: "What's the tournament format?",
    answer: "Teams compete in 16-team mini-brackets using single elimination. First-round losers advance to a losers bracket for a second chance to advance. Each team is guaranteed two matches."
  },
  {
    question: "When will the venue be announced?",
    answer: "Venue details will be emailed to all registered teams approximately 60 days before the event. Depending on the number of signups, we will be able to secure a premium location in Downtown Toronto, so please share this event with your friends!"
  },
  {
