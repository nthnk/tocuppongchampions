export function Footer() {
  return (
    <footer className="backdrop-blur-sm" style={{ borderTop: '1px solid rgba(226, 125, 96, 0.2)', background: 'rgba(255, 255, 255, 0.5)' }}>
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-bold uppercase tracking-wide mb-4" style={{ fontFamily: 'DM Sans, sans-serif', color: '#2D3436' }}>
              Quick Links
            </h4>
            <ul className="space-y-3">
              <li>
                <a
                  ...
                  style={{ fontFamily: 'DM Sans, sans-serif', color: '#2D3436', opacity: 0.7 }}
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                style={{ background: 'rgba(226, 125, 96, 0.2)', border: '1px solid rgba(226, 125, 96, 0.3)' }}
              >
                <svg className="w-6 h-6 transition-colors" style={{ color: '#2D3436' }} fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-full flex items-center justify-center transition-all hover:scale-110 group"
                style={{ background: 'rgba(195, 141, 158, 0.2)', border: '1px solid rgba(195, 141, 158, 0.3)' }}
              >
                <svg className="w-6 h-6 transition-colors" style={{ color: '#2D3436' }} fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Bottom Bar */}
        <div className="pt-8" style={{ borderTop: '1px solid rgba(226, 125, 96, 0.2)' }}>
          <div className="text-center">
            <p className="text-sm" style={{ fontFamily: 'DM Sans, sans-serif', color: '#2D3436', opacity: 0.5 }}>
