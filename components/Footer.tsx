...
export function Footer() {
  return (
    <footer style={{ background: palette.black, borderTop: `1px solid ${palette.slate}` }}>
      <div className="max-w-5xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            >
              Toronto's largest cup pong tournament.<br />
              Table Zero is the first chapter.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              {/* TikTok */}
              <a
                href="https://www.tiktok.com/@cuppongguy"
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 flex items-center justify-center transition-opacity hover:opacity-80"
                style={{ background: palette.slate }}
