    ...
    bracket: [
      {
        label: 'Round of 16',
        matches: [
          { winner: 0, a: { name: "Alpha's Shawarma", neighbourhood: 'Milliken',                   score: 1 }, b: { name: 'No Fast No Furious', neighbourhood: 'Scarborough Town Centre',     score: 0 } },
          { winner: 1, a: { name: "Dean's List",      neighbourhood: 'Downsview',                  score: 0 }, b: { name: 'The Watchmen',       neighbourhood: 'Weston',                      score: 1 } },
          { winner: 0, a: { name: 'The Pong Stars',   neighbourhood: 'Pleasantview',               score: 1 }, b: { name: 'Dino Thunder',       neighbourhood: 'Long Branch',                 score: 0 } },
          { winner: 0, a: { name: 'The Cup-Tains',    neighbourhood: 'St. Lawrence Market',        score: 1 }, b: { name: 'Delhi Daredevils',   neighbourhood: 'Church/Wellesley',            score: 0 } },
          { winner: 0, a: { name: 'Solo Dolo',        neighbourhood: 'North York/Yonge-Sheppard',  score: 1 }, b: { name: 'Nikhil & Vikash',    neighbourhood: 'East Danforth',               score: 0 } },
          { winner: 0, a: { name: 'Scarborough Dawgs',neighbourhood: 'Milliken',                   score: 1 }, b: { name: 'Asian Guy Is Single',neighbourhood: 'Milliken',                    score: 0 } },
          { winner: 1, a: { name: 'Jedz Boyz',        neighbourhood: 'The Annex',                  score: 0 }, b: { name: 'Pong Stars',         neighbourhood: 'Scarborough Village',         score: 1 } },
          { winner: 0, a: { name: 'Nathan Fill-Ups',  neighbourhood: 'Kensington Market',          score: 1 }, b: { name: "The Mayor's Office", neighbourhood: 'North York/Yonge-Sheppard',   score: 0 } },
        ],
      },
      {
        label: 'Quarter Finals',
        matches: [
          { winner: 1, a: { name: "Alpha's Shawarma", neighbourhood: 'Milliken',                   score: 0 }, b: { name: 'The Watchmen',       neighbourhood: 'Weston',                      score: 1 } },
          { winner: 0, a: { name: 'The Pong Stars',   neighbourhood: 'Pleasantview',               score: 1 }, b: { name: 'The Cup-Tains',      neighbourhood: 'St. Lawrence Market',         score: 0 } },
          { winner: 0, a: { name: 'Solo Dolo',        neighbourhood: 'North York/Yonge-Sheppard',  score: 1 }, b: { name: 'Scarborough Dawgs',  neighbourhood: 'Milliken',                    score: 0 } },
          { winner: 1, a: { name: 'Pong Stars',       neighbourhood: 'Scarborough Village',        score: 0 }, b: { name: 'Nathan Fill-Ups',    neighbourhood: 'Kensington Market',           score: 1 } },
        ],
      },
      {
        label: 'Semi Finals',
